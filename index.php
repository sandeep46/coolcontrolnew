        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/slider1.png" alt="Image" style="object-fit: cover;">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/slider2.png" alt="Image" style="object-fit: cover;">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <!-- <div class="col-lg-7 pt-5">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/slider3.png" alt="Image" style="object-fit: cover;">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <!-- <div class="col-lg-7 pt-5">
